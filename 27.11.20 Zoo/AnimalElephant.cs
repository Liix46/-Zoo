...
namespace _27._11._20_Zoo
{
    class AnimalElephant : IAnimal
    {
        ...
        public AnimalElephant() { }
        public AnimalElephant(string breed, int health, int bellyful, string imagePath, int xPos, int yPos)
        {
            _breed = breed;
            _health = health;
            _bellyful = bellyful;
