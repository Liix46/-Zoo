...
namespace _27._11._20_Zoo
{
    class AnimalGuepard : IAnimal
    {
        ...
        public AnimalGuepard() { }
        public AnimalGuepard(string breed, int health, int bellyful, string imagePath, int xPos, int yPos)
        {
            _breed = breed;
            _health = health;
            _bellyful = bellyful;
